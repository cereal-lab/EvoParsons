...
[#description#]
This program starts by generating two arrays of random int values, using the method getRandomArray.
...
The game consists in comparing the arrays element by element.
An array gets a point if its value at index i is greater than the value of the other array at that same index.
The method getRandomArray uses (Math.random()*10+1) to generate a random values in [1..10] that it then return.
