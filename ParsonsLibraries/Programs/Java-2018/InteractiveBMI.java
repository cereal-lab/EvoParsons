...
The BMI value returned by computeBMI is then passed as parameter to the method interpretBMI that returns a String indicating, based on the BMI value, whether the user is underweight (< 18.5), normal (< 25), overweight (< 30), or obese.
