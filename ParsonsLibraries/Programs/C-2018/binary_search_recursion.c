...
Function getData populates the array with  integers of SIZE, where SIZE = 5.
...
main function calls getData to populate  array and then prints 
messages if the element is found  or not.
You need to implement the functions in the order of main, getData and binarySearch.
Please note that this program expects that the user will input the array 
in ascending order.
